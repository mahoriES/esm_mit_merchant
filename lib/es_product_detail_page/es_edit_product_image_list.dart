...
class EsEditProductImageList extends StatefulWidget {
  final EsEditProductBloc esEdiProductBloc;

  EsEditProductImageList(
    this.esEdiProductBloc, {
    Key key,
  }) : super(key: key);

  @override
  _EsEditProductImageListState createState() => _EsEditProductImageListState();
}

class _EsEditProductImageListState extends State<EsEditProductImageList> {
  File imageFile;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<EsEditProductState>(
        ...
        builder: (context, snapshot) {
          ...
          var uploadedList = snapshot.data.currentProduct.images
              .map(
                        ...
                        children: <Widget>[
                          ...
                          Positioned(
                            ...
                            child: IconButton(
                              ...
                              onPressed: () {
                                widget.esEdiProductBloc.removeImage(dImage);
                              },
                              iconSize: 20,
