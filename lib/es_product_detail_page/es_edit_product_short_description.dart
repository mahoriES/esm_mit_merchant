...
class EsEditProductShortDescriptionPage extends StatefulWidget {
  static const routeName = '/create-business-page';

  final EsEditProductBloc esEditProductBloc;

  EsEditProductShortDescriptionPage(this.esEditProductBloc);

  @override
  EsEditProductShortDescriptionPageState createState() =>
      EsEditProductShortDescriptionPageState();
}

class EsEditProductShortDescriptionPageState
    extends State<EsEditProductShortDescriptionPage>
    with AfterLayoutMixin<EsEditProductShortDescriptionPage> {
