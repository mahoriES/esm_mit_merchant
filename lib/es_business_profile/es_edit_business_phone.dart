...
class EsEditBusinessPhonesPage extends StatefulWidget {
  final EsBusinessProfileBloc esBusinessProfileBloc;

  EsEditBusinessPhonesPage(this.esBusinessProfileBloc);

  @override
  EsEditBusinessPhonesPageState createState() =>
      EsEditBusinessPhonesPageState();
}

class EsEditBusinessPhonesPageState extends State<EsEditBusinessPhonesPage>
    with AfterLayoutMixin<EsEditBusinessPhonesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    submit() {
      if (this._formKey.currentState.validate()) {
        widget.esBusinessProfileBloc.addPhone(onSuccess, onFail);
      }
    }
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        controller: widget.esBusinessProfileBloc
                            .phoneNumberEditingControllers,
